              ...
              <div id='sidebar' className='col-md-4'>
                <div className='widget latest_news'>
                  ...
                  <ul className='bloglist-small'>
                    <li>
                      ...
                      <div className='txt'>
                        <h5>
                          <a href='css/index.html#'>Lin: 'God Is Challenging Me!'</a>
                        </h5>
                        <div>
                          <div>
                    ...
                    <li>
                      ...
                      <div className='txt'>
                        <h5>
                          <a href='css/index.html#'>Andraé Crouch goes Home to Jesus</a>
                        </h5>
                        Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                        accusantium doloremque
                      </div>
                ...
                <div className='widget widget-text'>
                  ...
                  <address>
                    ...
                    <span>
                      <strong>Email:</strong>
                      <a href='#'>contact@satriathemes.com</a>
                    </span>
                    <span>
                      <strong>Web:</strong>
                      <a href='#'>www.satriathemes.com</a>
                    </span>
                  </address>
                </div>
                ...
                <div className='widget widget-text'>
                  ...
                  Blessing is responsive website template for church build with latest
                  Bootstrap framework. Blessing is responsive with almost all devices
                  screen size supported. This template equipped with awesome features like
                  Revolution Slider, touch & swipe carousel, countdown timer and much more
                  features. Get ‘Blessing’ now!
                </div>
              </div>
            </div>
          </div>
